...
<div class="container-fluid">
    <div class="container">
        ...
        <div class="row" style="text-align: justify;">
            ...
            <button class="accordion"><strong>Sicherheit</strong></button>
            <div class="panel">
                <p><strong>Jeder in einem Kajak Fahrende muss schwimmen können und eine Schwimmweste tragen.</strong>
                    <br><br>Aus Sicherheitsgründen dürfen Kinder mit uns nur <strong>ab dem 12. Lebensjahr</strong> an
                    Kajakfahrten teilnehmen.
            ...
            <button class="accordion"><strong>Höhere Gewalt</strong></button>
            <div class="panel">
                <p><strong>Der AStA der HTWG</strong> ist bei einer Gesundheit gefährdenden Situation aufgrund der
                    Wetterlage
                    (Sturm, Unwetter, Überschwemmungen, extremes Niedrigwasser oder starker Nebel) berechtigt, <strong>Touren
                        abzusagen.</strong>
                    <br><br>In diesem Falle hat der Mieter <strong>keinen Anspruch</strong> auf Kostenerstattung von
                    Nebenkosten
                    (Anreise, Hotelübernachtung etc.).
                    Dieses gilt auch für den Fall, dass die Tour aufgrund niedriger Wasserstände nicht stattfindet oder
                    auf ein anderes Gewässer verlegt werden muss.</p>
            </div>
            <button class="accordion"><strong>Sorgfaltspflicht</strong></button>
            <div class="panel">
                <p><strong>Fahrverbote und private Gebote in Bereichen nicht öffentlicher Grundstücke sind
                        einzuhalten.</strong>
                    <br><br>Wiesen, Weiden und Felder an den Ufern sind in privatem Besitz und dürfen nicht betreten
                    oder zur Rast genutzt werden.
                    <strong>Während der Fahrt dürfen die Kajaks nur an öffentlichen und besonders gekennzeichneten
                        Rastplätzen verlassen werden.</strong>
                    Abfälle sind in mitzubringenden Mülltüten zu sammeln und, sofern vorhanden, am Ende der Tour in
